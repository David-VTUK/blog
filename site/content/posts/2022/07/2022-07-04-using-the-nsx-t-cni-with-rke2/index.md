---
title: "Using the NSX-T CNI with RKE2"
date: 2022-07-04
slug: "using-the-nsx-t-cni-with-rke2"
---
...
![](images/diagram-62c2f715cebb9.png)
...
![](images/img_4-62c2f724c15b9-1024x588.png)
...
[![](images/img_5-62c2f74f33797-1024x232.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/img_5.png)

- An IP Pool for `loadBalancer` service types

[![](images/img_6-62c2f75700631-1024x68.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/img_6.png)

# [](https://github.com/David-VTUK/rke2-nsxt/blob/master/readme.md#3-create-vm)
...
[![](images/vmconfig.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/vmconfig.png)

- Ensure `Python` is Installed (aka Python2)

# [](https://github.com/David-VTUK/rke2-nsxt#4-install-rke2)
...
# [](https://github.com/David-VTUK/rke2-nsxt#5-install-additional-cni-binaries)
...
# [](https://github.com/David-VTUK/rke2-nsxt#6-tag-the-overlay-network-port-on-the-vm)
...
[![img\_1.png](images/img_1.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/img_1.png)

- In NSX-T navigate to `Inventory -> Virtual Machines -> Select the VM`
- Select the port that's connected to the overlay switch

[![](images/img_2-62c2f774201a2-1024x342.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/img_2.png)

- Add the tags as appropriate

[![](images/img_3-62c2f77c56fb7-1024x662.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/img_3.png)

# [](https://github.com/David-VTUK/rke2-nsxt#7-download-the-ncp-operator-files)
...
# [](https://github.com/David-VTUK/rke2-nsxt#8-change-the-operator-yaml)
...
# [](https://github.com/David-VTUK/rke2-nsxt#9-change-the-configmap-yaml-file)
...
[![](images/network-topology-62c2f78a66a83-1024x314.png)](https://github.com/David-VTUK/rke2-nsxt/blob/master/images/network-topology.png)
